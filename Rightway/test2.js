...
function endTest(){
    ...
    document.getElementById("resultados").innerHTML = "<h2>Tu resultado: " + points + " puntos.</h2> <a href='pruebas.php' class=\"btn btn- btn-raised btn-lg\" style=\"width: 24%;\">Regresar</a>";
